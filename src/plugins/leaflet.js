...
export function createPopup(data) {
  return `
    ...
    <div class="d-flex mb-2 justify-content-between">
      <button type="button" class="btn btn-secondary me-1 text-white w-47.5">成人口罩 ${data.properties.mask_adult} 個</button>
      <button type="button" class="btn btn-secondary text-white w-47.5">兒童口罩 ${data.properties.mask_child} 個</button>
    </div>
